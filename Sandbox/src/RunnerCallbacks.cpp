...
std::string EdgeToolbarTypeName(EdgeToolbarType e)
{
 ...
 void RunnerCallbacks::AddEdgeToolbar(EdgeToolbarType edgeToolbarType, VoidFunction guiFunction, const EdgeToolbarOptions& options)
{
...
void RunnerCallbacks::EnqueueBeforeExit(const VoidFunction& callback)
{
	BeforeExit = SequenceFunctions(BeforeExit, callback);
}

void RunnerCallbacks::EnqueuePostInit(const VoidFunction& callback)
{
