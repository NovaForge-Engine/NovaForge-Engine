...
constexpr JPH::ObjectLayer collisionLayersCount =
	magic_enum::enum_count<CollisionLayer>();
...
constexpr JPH::BroadPhaseLayer::Type broadPhaseLayersCount =
	magic_enum::enum_count<BroadPhaseLayer>();
...
{
public:
	bool ShouldCollide(CollisionLayer inObject1,
...
{
public:
	virtual void OnBodyActivated(const JoltBodyID& inBodyID,
	                             JPH::uint64 inBodyUserData) override;
	virtual void OnBodyDeactivated(const JoltBodyID& inBodyID,
	                               JPH::uint64 inBodyUserData) override;
};
...
public:
	...
	virtual void DrawTriangle(JPH::RVec3Arg inV1, JPH::RVec3Arg inV2,
